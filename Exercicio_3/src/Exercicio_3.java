public class Exercicio_3 {
    public static void main(String[] args) throws InterruptedException {
        ...
        StencilCyclicBarrier stencil = new StencilCyclicBarrier(a,num_elements*1000,num_workers);//edge  value propagation requires more iterations for large arrays
